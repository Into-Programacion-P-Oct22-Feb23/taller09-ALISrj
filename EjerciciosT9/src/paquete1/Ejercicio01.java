    ...
    public static void main(String[] args) {
        ...
        */
        ...
        for (int i = 0; i < respuestas.length; i++) { 
            ...
            if ((respuesta >= 1) && (respuesta <=5)){ // Se cambió || por &&
                valoresRangos[0] = valoresRangos[0] + 1;
                
            }else{
                    
                if ((respuesta >= 6) && (respuesta <=10)){ // Se cambió || por &&
                    valoresRangos[1] = valoresRangos[1] + 1;
                }else{
                            
                    if ((respuesta >= 11) && (respuesta <=15)){ // Se cambió || por &&
                        valoresRangos[2] = valoresRangos[2] + 1; //3+1 
                    }else{
                        if ((respuesta >= 16) && (respuesta <=20)){ // Se cambió || por &&
